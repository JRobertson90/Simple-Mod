...
public class SlotCraftingChest extends Slot {
    ...
    private final IInventory craftingChest;
    ...
    public SlotCraftingChest(EntityPlayer par1EntityPlayer, IInventory tileEntity, IInventory resultSlot, int par4, int par5, int par6)
    {
        super(resultSlot, par4, par5, par6);
        this.thePlayer = par1EntityPlayer;
        this.craftingChest = tileEntity;
    }
    ...
    public void onPickupFromSlot(EntityPlayer par1EntityPlayer, ItemStack par2ItemStack)
    {
        ...
        for (int i = 0; i < 9; ++i)
        {
            ...
            if (itemstack1 != null)
            {
                craftingChest.decrStackSize(i+48, 1);
                ...
                if (itemstack1.getItem().hasContainerItem())
                {
                    ...
                    {
                        if (craftingChest.getStackInSlot(i+48) == null)
                        {
                            craftingChest.setInventorySlotContents(i+48, itemstack2);
                        }
                        else
                        {
