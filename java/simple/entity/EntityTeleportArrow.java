...
public class EntityTeleportArrow extends Entity implements IProjectile {
    ...
    public EntityTeleportArrow(World par1World)
    {
        super(par1World);
    ...
    public EntityTeleportArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityTeleportArrow(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityTeleportArrow(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, i1))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            if (this.shootingEntity != null)
                            {
                                ...
                                player.setPositionAndUpdate(movingobjectposition.entityHit.posX,  movingobjectposition.entityHit.posY, movingobjectposition.entityHit.posZ);
                            }
                ...
                else
                {
                    ...
                    //this.playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                    this.playSound("mob.endermen.portal1", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                    this.inGround = true;
                    this.arrowShake = 7;
                    ...
                    if(shootingEntity != null) {
                    	...
                    	double directionX = xTile - prevPosX;
                    	double directionY = yTile - prevPosY;
                    	double directionZ = zTile - prevPosZ;

                    	// Until you find a space to teleport to or reach 100 iterations.
                    	for(int iter = 0; iter < 100; iter++) {
                        	...
                        	if(isAirOrLiquid(worldObj, (int)portX, (int)portY, (int)portZ) && isAirOrLiquid(worldObj, (int)portX, ((int)portY)+1, (int)portZ)) {
                        		player.setPositionAndUpdate((int)portX, (int)portY, (int)portZ);
                        		iter = 100;
                        	}
                    	}
                    }
                    /* ------------------------------------------------  
                     *            End of Teleporting code
                     * ------------------------------------------------*/
    ...
    public boolean isAirOrLiquid(World world, int x, int y, int z)
    {
    	return world.isAirBlock(x, y, z) || world.getBlockMaterial(x, y, z) == Material.water || world.getBlockMaterial(x, y, z) == Material.lava;
    }
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(SimpleItems.arrow_teleport, 1)))
            {
                flag = false;
            }
     ...
     */
    public static DamageSource causeArrowDamage(EntityTeleportArrow par0EntityArrow, Entity par1Entity)
    {
