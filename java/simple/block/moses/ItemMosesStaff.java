...
public class ItemMosesStaff extends Item {
	...
	private boolean placeStaff(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int par7, float par8, float par9, float par10) {
		...
		{
			world.setBlock(x, y+1, z, SimpleBlocks.moses_staff.blockID, direction, 3);
			...
			if (world.getBlockId(x, y+1, z) == SimpleBlocks.moses_staff.blockID)
			{
				world.setBlock(x, y+2, z, SimpleBlocks.moses_staff.blockID, direction + 4, 3);
			}
	...
	private void recallStaff(ItemStack itemStack, EntityPlayer player, World world) {
		...
		if(world.getBlockId(staff_x, staff_y, staff_z) == SimpleBlocks.moses_staff.blockID) {
			...
			SimpleBlocks.moses_staff.onBlockDestroyedByPlayer(world,staff_x,staff_y,staff_z, meta);
		}
		else {
			itemStack.stackSize--;
		}
	...
	public static void addRecipe() {
		...
		GameRegistry.addRecipe(new ItemStack(SimpleItems.moses_staff, 1), new Object[] {"S ", "S ", "SB", 'S', Item.stick, 'B', Item.book});
		GameRegistry.addRecipe(new ItemStack(SimpleItems.moses_staff, 1), new Object[] {"S ", "SB", "S ", 'S', Item.stick, 'B', Item.book});
		GameRegistry.addRecipe(new ItemStack(SimpleItems.moses_staff, 1), new Object[] {"SB", "S ", "S ", 'S', Item.stick, 'B', Item.book});
		GameRegistry.addRecipe(new ItemStack(SimpleItems.moses_staff, 1), new Object[] {"S  ", "S  ", "S B", 'S', Item.stick, 'B', Item.book});
		GameRegistry.addRecipe(new ItemStack(SimpleItems.moses_staff, 1), new Object[] {"S  ", "S B", "S  ", 'S', Item.stick, 'B', Item.book});
		GameRegistry.addRecipe(new ItemStack(SimpleItems.moses_staff, 1), new Object[] {"S B", "S  ", "S  ", 'S', Item.stick, 'B', Item.book});
	}
