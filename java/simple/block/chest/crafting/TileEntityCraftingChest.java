...
public class TileEntityCraftingChest extends TileEntityChest implements IInventory {

    private ItemStack[] chestContents = new ItemStack[57];
    ...
    public TileEntityCraftingChest(int chestType)
    {
    ...
    private void func_174910_a(TileEntityChest p_174910_1_, EnumFacing p_174910_2_)
    {
        ...
        {
            switch (TileEntityCraftingChest.SwitchEnumFacing.field_177366_a[p_174910_2_.ordinal()])
            {
                case 1:
    ...
    protected TileEntityCraftingChest func_174911_a(EnumFacing p_174911_1_)
    {
        ...
        if (this.func_174912_b(blockpos))
        {
            ...
            {
                TileEntityCraftingChest tileentitychest = (TileEntityCraftingChest)tileentity;
    ...
    {
        return "xaeroxe_jayperdu_acm:crafting_chest";
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new ContainerCraftingChest(playerInventory, this, this.worldObj);
    }
    ...
    private List<ContainerCraftingChest> containers = new ArrayList<ContainerCraftingChest>();
    public void subscribe(ContainerCraftingChest ccc) {
        containers.add(ccc);
    }

    private void notifyContainers() {

        for(ContainerCraftingChest c : containers) {
            c.update();
        }
    }

    public void unsubscribe(ContainerCraftingChest ccc) {
        containers.remove(ccc);
    }
